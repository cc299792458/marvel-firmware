...
static void stabilizerTask(void* param)
{
  ...
  while(1) {
    ...
    if (healthShallWeRunTest()) {
      ...
      if(controllerType != ControllerTypeSinglePPID){
...
//This is used in supervisor.c, but I comment it on 2023/02/13
...
/**
 * @brief Controller type Any(0), PID(1), Mellinger(2), INDI(3), SinglePPID(4) (Default: 0)
 */

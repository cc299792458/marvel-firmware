...
int single_qc_ppid_step(void)
{
  ...
  diff_b = 6.28318548F * bcount_prev + q_Bbi_tmp_0;   // diff_b actually is the estimated beta value.
  ...
  /*********End of Bound and Type transform**********/
